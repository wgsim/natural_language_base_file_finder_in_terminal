...
- Python: 3.12
- Validated in a dedicated local development environment using the repository's
  documented setup in `environment.yml`

## Notes

- Using TDD approach: write failing test → implement → verify pass → commit
- Historical snapshot sanitized for public repository use
