...
| S2 | `model-bridge-mcp` | all-files | 0.032817 | 0.018384 | 0.560x |
| S2 | `model-bridge-mcp` | python-files | 0.013472 | 0.016311 | 1.211x |
| S2 | `model-bridge-mcp` | todo-content | 0.016435 | 0.020973 | 1.276x |
| S3 | `RNAseq_analysis_WebTool` | all-files | 0.353088 | 0.329904 | 0.934x |
| S3 | `RNAseq_analysis_WebTool` | python-files | 0.321681 | 0.325408 | 1.012x |
| S3 | `RNAseq_analysis_WebTool` | todo-content | 0.340536 | 0.340175 | 0.999x |
| S4 | `/tmp/askfind_bench_synth` | all-files | 0.082037 | 0.067752 | 0.826x |
| S4 | `/tmp/askfind_bench_synth` | python-files | 0.041206 | 0.043140 | 1.047x |
| S4 | `/tmp/askfind_bench_synth` | todo-content | 0.093594 | 0.106982 | 1.143x |
