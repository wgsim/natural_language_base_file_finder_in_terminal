...
/opt/homebrew/Caskroom/miniconda/base/envs/dev_tool_env_askfind/bin/python -m askfind "python files" --root <repo-root>

# Test verbose output
/opt/homebrew/Caskroom/miniconda/base/envs/dev_tool_env_askfind/bin/python -m askfind "python files" -v --root <repo-root>

# Test JSON output
/opt/homebrew/Caskroom/miniconda/base/envs/dev_tool_env_askfind/bin/python -m askfind "python files" --json --root <repo-root>
```
