...
| S2 | `sample-medium-public-repo` | all-files | 0.016110 | 0.017436 | 1.082x |
| S2 | `sample-medium-public-repo` | python-files | 0.015385 | 0.016163 | 1.051x |
| S2 | `sample-medium-public-repo` | todo-content | 0.018439 | 0.021623 | 1.173x |
| S3 | `sample-large-public-repo` | all-files | 0.354267 | 0.348926 | 0.985x |
| S3 | `sample-large-public-repo` | python-files | 0.340019 | 0.341560 | 1.005x |
| S3 | `sample-large-public-repo` | todo-content | 0.372253 | 0.359803 | 0.967x |
| S4 | `synthetic-bench-root` | all-files | 0.062445 | 0.060631 | 0.971x |
| S4 | `synthetic-bench-root` | python-files | 0.040838 | 0.042917 | 1.051x |
| S4 | `synthetic-bench-root` | todo-content | 0.094899 | 0.118373 | 1.247x |
